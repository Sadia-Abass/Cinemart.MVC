...
namespace Cinemart.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Index([FromQuery] UserListFilterViewModel filter)
        {
            ...
            try
            {
                var result = await _userRepository.GetAllUsersAsync(filter);
            ...
            catch (Exception ex) 
            {
                ...
                return View(new PagedResult<UserListFilterViewModel>()); // empty model to avoid null view
            }
        }
        ...
        public async Task<IActionResult> Create(CreateUserViewModel model)
        {
            try
            {
                ...
                var (result, newId) = await _userRepository.CreateUserAsync(model);
                if (result.Succeeded)
                {
        ...
        public async Task<IActionResult> Edit(Guid id)
        {
            try
            {
                var userEditViewModel = await _userRepository.GetForEditAsync(id);
        ...
        public async Task<IActionResult> Details(Guid id)
        {
            try
            {
                var userDetailsViewModel = await _userRepository.GetUserDetailsAsync(id);
        ...
        public async Task<IActionResult> ManageRoles(Guid id)
        {
            try
            {
                var userRolesEditViewModel = await _userRepository.GetRolesForEditAsync(id);
        ...
        public async Task<IActionResult> ManageRoles(UserRolesEditViewModel model)
        {
            ...
            try
            {
                ...
                var result = await _userRepository.UpdateRolesAsync(model.UserId, selected);
                if (result.Succeeded)
                {
                ...
                var userRolesEditViewModel = await _userRepository.GetRolesForEditAsync(model.UserId);
            ...
            catch (DbUpdateException dbx)
            {
                ...
                var vm = await _userRepository.GetRolesForEditAsync(model.UserId);
